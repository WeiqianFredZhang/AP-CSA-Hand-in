...
public class Main {
    public static void main(String[] args) {
        ...
        double a = 1, b = 5, c = 6;
        // stores one possible quadratic solution
        ...
        // stores the slope formula
        double slope = (y2 - y1)/(x2 - x1);
        // contains the String version of the coordinate pairs
        ...
        // stores the midpoint coordinates
        ...
        // stores the kth term of the arithmetic sequence
        ...
        // declared k is the number of terms in the geometric sequence, g_1 is the first term of the geometric sequence, and r is the common ratio between each term, and
